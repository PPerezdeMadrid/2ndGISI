...
#Existen 3 universos posibles: 
  #heart rate (HR) = a + b * temperatura
  # num1: HR = a [b=0]
  # num2: HR = a + b*t [b>0]
  # num3: HR = a + b*t [b<0]
...
```{r}
#¿Es el método V capaz de crear especies con el sépalo más grande?
# mu_setosa > mu_vI + mu_vII/2 --> mu_setosa - 0.5*mu_vI - 0.5*mu_vII > 0
# ¿Existe alguna diferencia entre V-I y V-II?
# mu_vI != mu_vII --> mu_vI - mu_vII != 0
